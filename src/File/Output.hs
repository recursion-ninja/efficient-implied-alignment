...
writeFastaFile
    :: HasAlignedString a SymbolString => AlphabetType -> Alphabet Char -> BTree b a -> FilePath -> IO ()
...
collectLeafAlignments :: HasAlignedString a SymbolString => BTree b a -> Map Text SymbolString

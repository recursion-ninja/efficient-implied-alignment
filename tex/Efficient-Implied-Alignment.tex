...
\textbf{TODO}
Aligning strings then searching, the resulting topology of the search is implied by the inital alignment. When using DO or implied alignment to search on a dynamic homology, the alignments depend on the toplogy.

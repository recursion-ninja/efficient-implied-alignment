...
This assignment assures the commutativity of $\otimes$, which is necessary to enforce consistency of the IA algorithm.
Additionally, the commutivitity of $\otimes$ ensures that the IA algorithm provides the same alignment results for isomorphic tree labeling (ie. ensures label invariance).
...
\section*{Declarations}
  ...
  \subsection*{Authors' contributions}
    ...
    WW provided empirical data sets, developed and implemented pruning methodologies for the scaling of the data sets, and literature review.

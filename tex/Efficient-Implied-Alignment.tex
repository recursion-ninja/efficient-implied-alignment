...
\begin{abstractbox}
	...
	\begin{abstract}
		...
		This reduction in the time complexity of the procedure dramatically improves both its utility in generating multiple sequence alignments and heuristic utility.
	\end{abstract}
...
We will show that this tagging and ``zipping'' process is a substantial improvement over previous work (quadratic to linear in number of leaves). 

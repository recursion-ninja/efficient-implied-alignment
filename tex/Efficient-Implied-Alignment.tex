...
Due to technical limitations, a direct runtime comparison between the $\mathcal{O}(k^2 * n^2)$ implementation in POY and our implementation was not readily achievable.

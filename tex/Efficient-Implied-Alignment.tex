...
For well behaved data, such as molecular sequences, the runtime approaches the best case runtime of \textsc{$\mathcal{O}(n * k)$}.
...
The pathological data sets shows the stark runtime difference between the best case $\mathcal{O}(n * k)$ and worst case $\mathcal{O}(n^2 * k)$ runtimes.
